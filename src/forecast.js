...
export class Filter extends Component {
    render() {
        return (
            ...
            <div><input id="labour-rate" type="radio" name="charttype" style={{border: 0, width: '5%', height: '1.5em'}}  defaultChecked="true" onClick={this.props.handleClick.bind(this)}>Labour Force Participation Rate</input>
            <input id="worker-population" type="radio" name="charttype" style={{border: 0, width: '5%', height: '1.5em'}}  onClick={this.props.handleClick.bind(this) } >Worker Population Ratio </input>
            <input id="unemployment-rate" type="radio" name="charttype" style={{border: 0, width: '5%', height: '1.5em'}} onClick={this.props.handleClick.bind(this)}>Unemployment Rate</input>
            <input id="proportion-unemployment" type="radio" name="charttype" style={{border: 0, width: '5%', height: '1.5em'}} onClick={this.props.handleClick.bind(this)}>Proportion Unemployed</input></div>
                    </div>);
    }
}
